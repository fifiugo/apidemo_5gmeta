...
@blueprint.route('/tag_vehiculardata', methods=['GET', 'POST'])
def entities():
    if request.method == "GET":
        return {
            'message': 'This endpoint should return a list of tag_vehiculardata',
...
@blueprint.route('/tag_vehiculardata/<int:entity_id>', methods=['GET', 'PUT', 'DELETE'])
